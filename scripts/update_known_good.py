...
REPOS_REQUIRING_UPDATING = ['Vulkan-Headers', 'Vulkan-Utility-Libraries', 'Vulkan-Loader', 'Vulkan-Tools']
...
def update_known_good_json():
    header_tags = query_tags_from_git_repo('https://github.com/KhronosGroup/Vulkan-Headers.git')
