...
def RunGenerators(api: str, registry: str,  directory: str, styleFile: str, targetFilter: str, caching: bool):
    ...
    try:
        code = common_codegen.RunShellCmd(f'clang-format --version')
...
def main(argv):
    ...
    parser.add_argument('paths', nargs='+',
                        help='Either: Paths to the Vulkan-Headers registry directory '
                        + ' OR path to the base directory containing the Vulkan-Headers repository')
    ...
    RunGenerators(args.api, registry, gen_dir, styleFile, args.target, caching)
